...
> ⚠ **Celdas sin verificar**, marcadas con ⚠ más abajo. Hay que resolverlas antes de programar
> el bloque J. Los comandos están en § _Cómo se verifica_.
...
| **J2**  | **Household overview**                            | **⚠ `adenda-01-huecos-navegacion.html`** | **Vista con dos versiones, y posiblemente tres.** La base vive en `bloque-j-familiar.html`; la de la adenda 01 la reemplaza porque agrega la fila de entrada a J8 ("Vos y Ana"). ⚠ **Verificar si `adenda-02-modo-espejo.html` la tocó otra vez**: si el espejo se entra desde J2, esta fila pasa a apuntar a la adenda 02. Ver § _Cómo se verifica_.                 |
| J3      | Invitar · email o QR                              | `bloque-j-familiar.html`                 |                                                                                                                                                                                                                                                                                                                                                                       |
| **J4**  | **Permisos y visibilidad**                        | **⚠ `adenda-02-modo-espejo.html`**       | ⚠ **Verificar.** Si la adenda 02 le agregó la entrada al espejo, manda la adenda; si el espejo se entra desde otro lado y J4 quedó intacta, manda `bloque-j-familiar.html`. Ver § _Cómo se verifica_.                                                                                                                                                                 |
