...
|---|---|---|---|
| 00 | `00-producto.md` | Análisis de producto: features, módulos, indicadores, gráficos, roadmap, riesgos | Léelo una vez. Es la fuente de verdad de *qué* se construye. |
...
| 08 | `08-cierre-de-diseno.md` | Lo que la reconciliación dejó abierto: 3 prompts de diseño, 17 arreglos que van a código y las 6 decisiones que destraban C2 | Después de la sesión 0 |
