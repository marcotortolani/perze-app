...
export const CATEGORY_ICON_GROUPS: readonly CategoryIconGroup[] = [
  ...
  { id: "transport", icons: ["car", "fuel", "bus", "train", "plane", "bicycle", "luggage", "letter-circle-p", "taxi", "motorcycle", "road", "globe"] },
  ...
  { id: "leisure", icons: ["film", "music", "gamepad", "ticket", "popcorn", "ball", "barbell", "monitor-play", "guitar", "confetti", "tent", "mountains", "running", "camera"] },
